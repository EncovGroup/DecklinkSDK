...
typedef signed long long int BMDTimeValue;
typedef signed long long int BMDTimeScale;
typedef unsigned long int BMDTimecodeBCD;
typedef unsigned long int BMDTimecodeUserBits;
